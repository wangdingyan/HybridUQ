...
class TrainArgs(CommonArgs):
    ...
    # Uncertainty estimation related arguments
    """Using Mean-Variance Estimation"""
    mve: bool = False
    """Using SQR Uncertainty Estimates"""
    sqr: bool = False
    """Using Certificates-based Uncertainty Estimates"""
    certificate: bool = False
    """Using Gaussian Process Estimates"""
    gprocess: bool = False
    """Using PinBall-based Quantile Regression"""
    quantileregression: Literal['None', 'Pinball', 'Calibration', 'ScaledCalibration', 'CalibrationSharpness', 'Interval'] = 'None'
    p_up: float = 0.9
    p_low: float = 0.1
    """Using MC-dropout for uncertainty estimation"""
    mcdropout: bool = False
    mcdropoutnum: int = 50

    """Using Mondrian Conformal Prediction"""
    conformal : bool  = False
    conformalp: float = 0.9
...
class HyperoptArgs(TrainArgs):
    num_iters         :  int = 20
    config_save_path  :  str            # Path to :code:`.json` file where best hyperparameter settings will be written.
